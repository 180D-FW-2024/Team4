...
async def synthesize_and_play(text: str):
    ...
    try:
        ...
        subprocess.run(
            ["aplay", "-D", "plughw:2,0", temp_wav_path],
            check=True
        )
    ...
    with sr.Microphone() as mic:
        ...
        while True:
            try:
                ...
                # It must include the word "system" and one of: "on", "off", "activate", "deactivate".
...
UDP_IP = "mainserverpi.local"  # Example direct IP (recommended)
UDP_PORT = 5200
